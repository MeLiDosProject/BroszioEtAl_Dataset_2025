...
This repository contains the comprehensive dataset for the [MeLiDos](www.melidos.eu) field study site of Dortmund, Germany. Data were collected by [Federal Institute for Occupational Safety and Health (BAuA)](https://www.baua.de) and are further processed and analysed by the [Translational Sensory & Circadian Neuroscience Unit (TSCN)](https://www.tscnlab.org). A detailed description of the experiment is available in [Guidolin et al., 2024](https://www.ncbi.nlm.nih.gov/pubmed/39592960).
...
> Broszio, K., Zauner, J., & Spitschan, M. (2025). Personal light exposure dataset for Dortmund, Germany (Version 1.0.0) [Data set]. URL: https://github.com/MeLiDosProject/BroszioEtAl_Dataset_2025. DOI: doi.org/10.5281/zenodo.18111232
...
![Summary table of chronotype questionnaires](output/tables/table_chronotype.png)
...
- `data/Metadata_Melidos_BAUA.xlsx`: Preliminary Metadata prior to conversion to JSON

- `data/Study_dates_MeLiDos_BAUA.xlsx`: Recruitment dates to clean light exposure recordings
...
## Individual
This folder contains individual-level data for N=22 participant, each stored in a separate folder named after the participant ID (PID). The data within each participant folder follows the following structure. 
