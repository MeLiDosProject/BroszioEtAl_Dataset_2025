...
`BAUA_S023` has a basically flat trajectory and will be excluded from further analysis:

```{r}
data_cleaned |> sample_groups(sample = 18) |> gg_days()

data_cleaned <-
  data_cleaned |> filter_out(Id == "BAUA_S023")
```
